...
struct compress_ctx {
	...
	void *_private;			/* work buf for compress algorithm */
};
...
/*
 * For SEC extra flag block
 */
#define F2FS_SEC_FSCK_MAGIC	0xF5CE45EC
#define FSCK_SPO_CNT_THR	23U
struct f2fs_extra_flag_blk {
	__le32 need_fsck;
	__le32 spo_counter;
...
extern void stlog(char const *fmt, ...);
