...
public class KeyStore {
    ...
    * @hide
    */
    public Enumeration<String> list(int mode) throws KeyStoreException {
        if (!initialized) {
          throw new KeyStoreException("Uninitialized keystore");
    }

        return keyStoreSpi.engineList(mode);
    }

    /**
    *@hide
    */
    public Enumeration<String> list(String prefix, String name) throws KeyStoreException {
        if (!initialized) {
            throw new KeyStoreException("Uninitialized keystore");
    }
        return keyStoreSpi.engineList(prefix, name);
    }
    /**
     * @hide
     */
    public boolean containsAlias(String prefix, String name) throws KeyStoreException {
        if (!initialized) {
            throw new KeyStoreException("Uninitialized keystore");
        }
        return keyStoreSpi.engineContainsAlias(prefix, name);
    }

    /**
    *@hide
    */
    public boolean containsUniquePrivateKey(String name) throws KeyStoreException {
        if (!initialized) {
            throw new KeyStoreException("Uninitialized keystore");
        }
        return keyStoreSpi.engineContainsUniquePrivateKey(name);
    }

    /**
    *@hide
    */
    public String retrieveUniquePrivateKeyAlias(String name) throws KeyStoreException {
        if (!initialized) {
            throw new KeyStoreException("Uninitialized keystore");
        }
        return keyStoreSpi.engineRetrieveUniquePrivateKeyAlias(name);
    }
    /**
     * @hide
     */
    public byte[] getCSR(String alias) throws KeyStoreException {
        if (!initialized) {
            throw new KeyStoreException("Uninitialized keystore");
        }
        return keyStoreSpi.engineGetCSR(alias);
    }
